    ...
    const demoNotifications = [
        {
            id: 1,
            title: "Tugas Baru",
            message: "Laporan Praktikum Jaringan telah diunggah.",
            time: "5 menit lalu",
            read: false,
        },
        {
            ...
            message: "Kelas Matematika pindah ke Ruang Lab 2.",
            time: "1 jam lalu",
            read: false,
        },
        {
            id: 3,
            title: "Pengumuman",
            message: "Ujian Tengah Semester dimulai 20 April.",
            time: "3 jam lalu",
            read: true,
        },
        {
            ...
            message: "Sesi konseling Anda telah dikonfirmasi.",
            time: "Kemarin",
            read: true,
        },
    ];
    ...
    return (
        <div className="min-h-screen flex bg-gray-50">
                            ...
                            return (
                                <li key={index}>
                                    <Link
                                        ...
                                        className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm md:text-base font-medium transition-all ${
                                            isActive
                    ...
                    <ul className="space-y-1">
                        <li>
                            <Link
                                ...
                                className="flex items-center gap-3 px-4 py-3 rounded-xl md:text-base font-medium text-gray-600 hover:bg-gray-100 transition-all"
                            >
                                <svg
                        ...
                        <li>
                            <Link
                                ...
                                method="post"
                                as="button"
                                className="w-full flex items-center gap-3 px-4 py-3 rounded-xl md:text-base font-medium text-red-600 hover:bg-red-50 transition-all"
                            >
                                <svg
                                    className="w-5 h-5"
                                    fill="none"
            ...
            <div
                ...
                style={{
                    marginLeft:
                        sidebarOpen && window.innerWidth >= 768 ? "250px" : "0",
                }}
            >
                {/* ─── Header ─────────────────────────────────────────────────── */}
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative" ref={notifRef}>
                            ...
                            {notifOpen && (
                                <div
                                    className="
  fixed left-1/2 -translate-x-1/2 top-16 w-80
  md:absolute md:left-auto md:translate-x-0 md:right-0 md:top-full
  bg-white rounded-2xl shadow-lg border border-gray-100 z-50 overflow-hidden animation-scale-in
"
                                >
                                    ...
                                    <div className="max-h-80 overflow-y-auto">
                                        {demoNotifications.map((n) => (
                                            <div
                                                key={n.id}
                                                className={`px-4 py-3 border-b border-gray-50 hover:bg-gray-50 transition cursor-pointer ${!n.read ? "bg-blue-50/30" : ""}`}
                                            >
                                                <div className="flex items-start gap-3">
                                                    <div
                                                        className={`w-2 h-2 rounded-full mt-1.5 shrink-0 ${!n.read ? "bg-primary-500" : "bg-transparent"}`}
                                                    />
                                                    <div className="flex-1 min-w-0">
                                                        <p
                                                            className={`text-base ${!n.read ? "font-semibold text-gray-900" : "font-medium text-gray-700"}`}
                                                        >
                                                            {n.title}
                                                        </p>
                        ...
                        <div className="relative" ref={profileRef}>
                            ...
                            >
                                ...
                                <div className="text-left hidden sm:block">
                                    <p className="md:text-base font-medium text-gray-900 leading-none">
                            ...
                            {profileOpen && (
                                <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50 animation-scale-in">
                                    <Link
                                        href={profileHref}
                                        className="flex items-center gap-2 px-4 py-2.5 md:text-base text-gray-700 hover:bg-gray-50 transition"
                                    >
                                        <svg
                                            className="w-4 h-4"
                                            fill="none"
                                    ...
                                    <Link
                                        ...
                                        method="post"
                                        as="button"
                                        className="w-full flex items-center gap-2 px-4 py-2.5 md:text-base text-red-600 hover:bg-red-50 transition"
                                    >
                                        <svg
                                            className="w-4 h-4"
                                            fill="none"
